...
public final class TextProvider {
    ...
    private static <T> T randomChoice(List<T> data) {
    ...
    private static List<String> famous = Arrays.asList(
    ...
    private static List<String> remark = Arrays.asList(
    ...
    private static List<String> before = Arrays.asList(
            "曾经说过",
            "在不经意间这样说过",
            "说过一句著名的话",
            "曾经提到过",
